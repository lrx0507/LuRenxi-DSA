...
public class BSTBookImplementationCountSort implements Book {
    ...
    private CountSortKeyValueBSearchTree<Integer> wordCountBST;
    ...
    public BSTBookImplementationCountSort()
    {
        wordCountBST = new CountSortKeyValueBSearchTree<>();
